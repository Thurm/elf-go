...
class ScriptParser {
     ...
     * @returns {boolean} 条件是否满足
     */
    evaluateConditionString(conditionStr, gameState) {
     ...
     * @returns {Object} 执行结果
     */
    handleGiveItems(data, gameState) {
     ...
     * @returns {Object} 执行结果
     */
    handleGiveMonster(data, gameState) {
     ...
     * @returns {Object} 执行结果
     */
    handleStartQuest(data, gameState) {
     ...
     * @returns {Object} 执行结果
     */
    handleCompleteQuest(data, gameState) {
        if (!data || !data.questId) {
     ...
     * @returns {Object} 执行结果
     */
    handleCloseDialog(data, gameState) {
